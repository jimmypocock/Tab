-- Fix organization creation function with proper search_path
...
BEGIN
  ...
  -- Create organization (bypasses RLS)
  ...
  -- Add user as owner (bypasses RLS)
...
DO $$
BEGIN
  RAISE NOTICE 'Fixed organization creation function with SECURITY DEFINER to bypass RLS';
END $$;